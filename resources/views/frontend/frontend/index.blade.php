...
<div class="modal" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div id="mb" class="modal-body text-center">
                You Need To Login to Register.
            </div>

            <!-- Modal footer -->
            <div class="modal-footer">
               <a href="{{route('login')}}"> <button type="button"  style="color:#DD6B55;" class="ackBtn btn btn-info" >Login</button></a>
            ...
            <div class="col-md-8 pb-5">
                ...
                <form class="form-inline">
                    ...
                    <button type="submit" class="btn btn-primary ml-1 pl-5 pr-5"
                            style="background-color: #44CF6C; border-color: #44CF6C;">Subscribe</butto
