        ...
        <div class="row pt-5">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" name="email"  @error('email') is-invalid @enderror class="form-control" id="emsil" placeholder="Your Email Address" required>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="password" name="password"  @error('password') is-invalid @enderror class="form-control" id="password" placeholder="Your Password" minlength="8" maxlength="21" required>
